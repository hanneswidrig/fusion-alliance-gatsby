...
`
const LogoSection = styled.section`height: 48px;`
	...
	return (
		<Header>
			<Nav>
				...
				<NavSection>
					<Link to="/expertise/" activeStyle={activeLinkStyle}>EXPERTISE</Link>
					<Link to="/products/" activeStyle={activeLinkStyle}>PRODUCTS</Link>
					<Link to="/about/" activeStyle={activeLinkStyle}>ABOUT</Link>
					<Link to="/contact/" activeStyle={activeLinkStyle}>CONTACT</Link>
					<Link to="/careers/" activeStyle={activeLinkStyle}>CAREERS</Link>
				</NavSection>
			</Nav>
		</Header>
	)
